...
public class TestResource {
    ...
    @Path("stateless/{arg}")
    @Produces("text/plain")
    public String testTransactionPresent(@Context SecurityContext context,
    ...
    @Path("fault/{arg}")
    @Produces("text/plain")
    public String injectFault(@Context SecurityContext context,
                              @QueryParam("tx") @DefaultValue("FALSE") boolean inTxn,
                              @PathParam("arg") String arg) {
        return localBean.injectFault(arg, inTxn);
    }
